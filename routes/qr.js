            ...
            Gifted.ev.on("connection.update", async (s) => {
                ...
                if (qr && !responseSent) {
                    ...
                    if (!res.headersSent) {
                        res.send(`
                            ...
                            <html>
                            <head>
                                <title>Yeoboe-xmd| QR CODE</title>
                ...
                if (connection === "open") {
                    ...
                    try {
                        ...
                        const sessionString = 'Yeoboe-X:~' + b64data;
                        ...
                        await sendButtons(Gifted, Gifted.user.id, {
                            ...
                            text: `*Your session has been generated successfully!*\n\n` +
                                  `📋 *Session ID:* Yeoboe-xmd:~${b64data.substring(0, 20)}...\n\n` +
                                  `📌 *Copy the full session below:*`,
                            footer: 'Powered by Yeoboe,
                            buttons: [
                                { 
                                    name: 'cta_copy', 
                                ...
                                },
                                {
                                    ...
                                    buttonParamsJson: JSON.stringify({
                                        ...
                                        url: 'https://github.com/Yeoboe/Yeoboe-xmd 
                                    })
                                },
                                {
                                    name: 'cta_url',
                                    buttonParamsJson: JSON.stringify({
                                        ...
                                        url: 'https://whatsapp.com/channel/0029VbDeXKrD38CVAKNfom42'
                                    })
                                }
                            ]
                        });
